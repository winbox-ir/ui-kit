...
export const theme: ToggleSwitchTheme = {
  ...
  toggle: {
    base: "after:content-[''] after:block after:rounded-full after:w-5 after:h-5 after:bg-white h-6 w-11 rounded-full border group-focus:ring-4 group-focus:ring-blue-500/25",
    checked: {
