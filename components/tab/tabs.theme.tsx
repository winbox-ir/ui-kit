import { FlowbiteTabTheme } from './Tabs'

export const theme: FlowbiteTabTheme = {
  ...
  tablist: {
    ...
    styles: {
      ...
      groupedButtons: 'hidden text-sm font-medium rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400',
    },
    tabitem: {
      base: 'flex items-center justify-center py-2 px-4 text-sm font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500',
      styles: {
        default: {
          base: 'rounded-t-lg',
          active: {
