...
export interface TitleProps extends PropsWithChildren<Omit<ComponentProps<"label">, "color">> {
  color?: keyof TitleColors
  value?: string
  disabled?: boolean
}

export const Title: FC<TitleProps> = ({ children, color = "default", disabled = false, value, className, ...props }): JSX.Element => {
  return (
